...
app.post("/api/contact", async (req, res) => {
  ...
  try {
    ...
    const userMailOptions = {
      ...
      subject: `We Have Received Your Message from
       ${name} ${surname}`, // subject
      html: `
        <p>We have received your message and will be in touch shortly. In the 
        meantime, if you have any further questions or additional information 
        to share, please feel free to reply to this email.</p>
        ...
        <p>Thank you for your message. We have received your inquiry and will 
        get back to you as soon as possible. Our team typically responds within 
